package com.hq.tool.bitmap.qrcode.zxing;
/*
...
import static com.hq.tool.bitmap.qrcode.zxing.ViewfinderView.FrameGravity.CENTER;
...
//    private int resultPointColor;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        maskColor = array.getColor(R.styleable.ViewfinderView_maskColor, context.getColor(R.color.viewfinder_mask));
        frameColor = array.getColor(R.styleable.ViewfinderView_frameColor, context.getColor(R.color.viewfinder_frame));
        cornerColor = array.getColor(R.styleable.ViewfinderView_cornerColor, context.getColor(R.color.viewfinder_corner));
        laserColor = array.getColor(R.styleable.ViewfinderView_laserColor, context.getColor(R.color.viewfinder_laser));
//        resultPointColor = array.getColor(R.styleable.ViewfinderView_resultPointColor, ContextCompat.getColor(context,R.color.viewfinder_result_point_color));
        ...
        labelTextColor = array.getColor(R.styleable.ViewfinderView_labelTextColor, context.getColor(R.color.viewfinder_text_color));
...
//        isShowResultPoint = array.getBoolean(R.styleable.ViewfinderView_showResultPoint,false);
    ...
    public void setLabelTextColorResource(@ColorRes int id){
        this.labelTextColor = getContext().getColor(id);
    }
