...
fun Activity.showNoticeNew(pushId:Int,icon:Int,title: String,text:String,peer:String,num:Int,isLight: Boolean): Unit {
...
fun Activity.showNoticeNewNoJump(pushId:Int,icon:Int,title: String,text:String,peer:String,num:Int,isLight: Boolean): Unit {
    val mNotificationManager = getSystemService(AppCompatActivity.NOTIFICATION_SERVICE) as NotificationManager
    val mBuilder = NotificationCompat.Builder(this)
    //  val notificationIntent = Intent(this, this::class.java)
    //  notificationIntent.putExtra("pushId",pushId)
