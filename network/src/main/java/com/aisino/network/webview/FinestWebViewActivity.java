package com.aisino.network.webview;
...
import com.aisino.network.R;
import com.aisino.network.webview.enums.Position;
import com.aisino.network.webview.helpers.BitmapHelper;
import com.aisino.network.webview.helpers.ColorHelper;
import com.aisino.network.webview.helpers.TypefaceHelper;
import com.aisino.network.webview.helpers.UrlParser;
import com.aisino.network.webview.listeners.BroadCastManager;
import com.aisino.network.webview.views.ShadowLayout;
...
public class FinestWebViewActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener, View.OnClickListener {
    ...
    public static FinestWebView.Builder cbuilder;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        initializeOptions();//初始化build
    ...
    protected void initializeOptions() {
        ...
        rtl = builder.rtl != null ? builder.rtl : false;
        ...
        { // ProgressBar
            ...
            switch (progressBarPosition) {
                ...
                case BOTTOM_OF_WEBVIEW:
                    params.setMargins(0, getHeight() - (int) progressBarHeight, 0, 0);
                    break;
            }
    ...
    protected int getMaxWidth() {
        if (forward.getVisibility() == View.VISIBLE) {
            return getWidth() - (int) (100 * getResources().getDisplayMetrics().density + 0.5f);
        } else {
            return getWidth() - (int) (52 * getResources().getDisplayMetrics().density + 0.5f);
        }
    }
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
        ...
        if (menuLayout.getVisibility() == View.VISIBLE && Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
    ...
    protected void requestCenterLayout() {
        ...
        if (webView.canGoBack() || webView.canGoForward()) {
            maxWidth = getWidth() - (int) (48 * getResources().getDisplayMetrics().density + 0.5f) * 4;
        } else {
            maxWidth = getWidth() - (int) (48 * getResources().getDisplayMetrics().density + 0.5f) * 2;
        }
