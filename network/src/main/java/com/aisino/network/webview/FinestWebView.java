...
import com.aisino.network.webview.listeners.WebViewListener;
...
public class FinestWebView  {
  ...
  public class Builder implements Serializable {
    ...
    protected  List<WebViewListener> listeners = new ArrayList<>();
...
//      Base.initialize(context);
    ...
    public Builder swipeRefreshColorRes(@ColorRes int colorRes) {
      this.swipeRefreshColor = getColor(colorRes);
      return this;
    }
    ...
    public Builder swipeRefreshColorsRes(@ArrayRes int colorsRes) {
      int[] colors = getIntArray(colorsRes);
    ...
    private void show(String url, String data) {
      ...
      FinestWebViewActivity.cbuilder=this;
